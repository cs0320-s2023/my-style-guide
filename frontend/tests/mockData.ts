...
import { MapFailureResponse } from "../src/utils/overlays";
...
const NoFoundFeats: MapFailureResponse = {
  result: "error_bad_request",
  error_message: "Error: keyword 'undefinedKey' not found in GeoJSON area descriptions"
}

export {ProvidenceMockFeats, NoFoundFeats};